...
export const FeatureCard: React.FC<Feature> = ({ icon, title, description }) => {
  return (
    <div className="bg-white dark:bg-slate-800/50 rounded-xl p-8 border border-slate-200 dark:border-slate-700 card-hover hover-lift hover-glow transition-colors transition-shadow duration-300 relative">
